<template>
  <el-form :model="admin" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm login-container">
      ...
      handleSubmit2(ev) {
        ...
        this.$refs.ruleForm2.validate((valid) => {
          if (valid) {
            ...
            this.logining = true;
            //NProgress.start();
            var loginParams = { username: this.admin.username, password: this.admin.password };
